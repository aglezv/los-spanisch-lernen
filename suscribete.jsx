...
export default function Suscribete() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 p-8 text-center text-gray-800 flex flex-col justify-center items-center">
      <h1 className="text-4xl font-bold text-blue-700 mb-4">Suscríbete al método LOS</h1>
      {submitted ? (
        <p className="text-lg text-green-600">¡Gracias por suscribirte! Pronto nos pondremos en contacto contigo.</p>
      ) : (
        <form
